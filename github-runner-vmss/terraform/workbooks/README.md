...
| **Capacity & autoscale** | Scale set metrics + `AzureDiagnostics` | Queued-jobs autoscale metric, platform CPU, runner count over time, autoscale **scale actions** and **evaluations** (needs `enable_autoscale_diagnostics`) |
